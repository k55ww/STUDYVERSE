...
export default function StudyAssistantPage() {
  ...
  const filteredTools = studyTools.filter((tool: any) =>
  ...
  return (
    <main style={{ minHeight: "100vh", backgroundColor: "#030712", color: "white", padding: "40px 24px" }}>
      <div style={{ maxWidth: "1000px", margin: "0 auto" }}>
        ...
        <h1 style={{ fontSize: "40px", fontWeight: "800", marginBottom: "10px" }}>Study Assistant Hub</h1>
        <p style={{ color: "#94a3b8", marginBottom: "24px" }}>Flashcards, quizzes, summaries, and smart study planner tools.</p>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(280px, 1fr))", gap: "16px" }}>
          {filteredTools.map((tool: any) => (
            <Link key={tool.id} href={`/study-assistant/${tool.id}`} style={{ textDecoration: "none", color: "inherit" }}>
